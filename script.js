...
d3.csv("/Users/eddieseet/Desktop/kellystuff/data/temp_daily.csv").then(draw);
...
//   var groups = d3.map(data, (d) => d.date).keys();
//   var vars = d3.map(data, (d) => d.avg_temperature).keys();
...
//     d3.select(ref).style("stroke-opacity", 0.5).style("fill-opacity", 0.7);
//   }
